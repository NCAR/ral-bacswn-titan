...
Mpumalan  gray60    1    Fixed   8  0 6   1    1  1   $(MERGE_HOME)/maps/border/mpumalan.map
...
#-------------------------------RINGS-----------------------------------------------------
BL_ring grey80    1    Fixed   8  0 6   1    0  1   $(MERGE_HOME)/maps/rings/BL_ring
BM_ring grey80    1    Fixed   8  0 6   1    0  1   $(MERGE_HOME)/maps/rings/BM_ring
CT_ring grey80    1    Fixed   8  0 6   1    0  1   $(MERGE_HOME)/maps/rings/CT_ring
DN_ring grey80    1    Fixed   8  0 6   1    0  1   $(MERGE_HOME)/maps/rings/DN_ring
DY_ring grey80    1    Fixed   8  0 6   1    0  1   $(MERGE_HOME)/maps/rings/DY_ring
EL_ring grey80    1    Fixed   8  0 6   1    0  1   $(MERGE_HOME)/maps/rings/EL_ring
EO_ring grey80    1    Fixed   8  0 6   1    0  1   $(MERGE_HOME)/maps/rings/EO_ring
#GB_ring grey80    1    Fixed   8  0 6   1    0  1   $(MERGE_HOME)/maps/rings/GB_ring
IR_ring grey80    1    Fixed   8  0 6   1    0  1   $(MERGE_HOME)/maps/rings/IR_ring
PE_ring grey80    1    Fixed   8  0 6   1    0  1   $(MERGE_HOME)/maps/rings/PE_ring
TZ_ring grey80    1    Fixed   8  0 6   1    0  1   $(MERGE_HOME)/maps/rings/TZ_ring
WB_ring grey80    1    Fixed   8  0 6   1    0  1   $(MERGE_HOME)/maps/rings/WB_ring
#--------------------------------Radars---------------------------------------------------
Radars     red    1    Fixed   8  0 6   2    0  1   $(MERGE_HOME)/maps/merge_radars.map
#-----------------------------------------------------------------------------------------
