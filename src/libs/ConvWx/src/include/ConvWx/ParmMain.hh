...
public:
  ...
  bool pDebug;             /**< true to log messages of LogStream::DEBUG */
  bool pDebugVerbose;     /**< true to log messages of LogStream::DEBUG_VERBOSE */
  bool pDebugTrigger;     /**< true to log messages of LogStream::TRIGGER */
