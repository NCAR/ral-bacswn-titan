...
public:
   ...
   */
  void addInputUv(const std::string &path, double latencyHours);
  void addInputUvSeconds(const std::string &path, int latencySeconds);
   ...
   * @param[in] latencyHours  Latency hours
   */
  void addModelInput(const std::string &path, double latencyHours);
  void addModelInputSeconds(const std::string &path, int latencySeconds);
  ...
  void replaceModelInput(const std::string &modelPath,
			 double latencyHours);
  void replaceModelInputInt(const std::string &modelPath,
                            int latencySeconds);
  ...
  bool getModelLatencySeconds(int &latency) const;
  ...
  bool getInputUvLatencySeconds(int &latency) const;
...
private:  
  ...
  double pModelLatencyHours;  /**< model input latency hours, when
			       *   pHasModelInput=true */
  int pModelLatencySeconds;  /**< model input latency seconds, when
                              *   pHasModelInput=true */
  /** @} */
  ...
  double pUvInputLatencyHours; /**< UV input latency hours, when
				*   pHasUvInput=true */
  int pUvInputLatencySeconds; /**< UV input latency seconds, when
				*   pHasUvInput=true */
  /** @} */
  ...
  static const std::string pUvLatencySecondsTag; /**< tag in XML for UV latency */
  ...
  static const std::string pModelLatencySecondsTag; /**< XML tag for model latency */
