...
public:
 ...
 inline int getNz(void) const { return  pNptZ; }
  ...
  void nearbyNonMissingGTZero( const int centerX, const int centerY, const int sx,
  ...
  /**
   * Set data at points where below a threshold to a fixed value
   * 
   * @param[in] floorValue  The threshold to use
   * @param[in] replacementValue  The value to replace with
   *
   * @return  Number of points at which the value was changed
   */
  int replaceBelowThresh(double floorValue,
