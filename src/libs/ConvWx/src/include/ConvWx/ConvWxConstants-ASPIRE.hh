 ...
 */
const int FCST_RESOLUTION_SECS = 3600;
...
/**
  ...
  */
const float MAX_LEAD_HOUR = 12;

/**
  * constant for maximum allowed model latency in ConvWx
  */
const float MAX_MODEL_LATENCY_HOURS = 2;
...
/**
 * A bad latency seconds value used for error returns or uninitialized state
 */
const int BAD_LATENCY_SECONDS = -99;
